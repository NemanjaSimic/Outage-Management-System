...
namespace Outage.SCADA.ModBus.ModbusFuntions
{
    ...
    {
        public ReadDiscreteInputsFunction(ModbusCommandParameters commandParameters, ModbusClient modbusClient) 
        ...
        public override void Execute()
        {
            ...
            bool[] data = ModbusClient.ReadDiscreteInputs(mdb_read_comm_pars.StartAddress, mdb_read_comm_pars.Quantity);
