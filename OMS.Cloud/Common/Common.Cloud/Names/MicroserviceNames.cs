namespace OMS.Common.Cloud.Names
{
    ...
    {
        //NMS
        public const string NmsGdaService = "NmsGdaService";

        //SCADA
        public const string ScadaCommandingService = "ScadaCommandingService";
        public const string ScadaModelProviderService = "ScadaModelProviderService";
        public const string ScadaFunctionExecutorService = "ScadaFunctionExecutorService";
        public const string ScadaAcquisitionService = "ScadaAcquisitionService";
        ...
        public const string OmsOutageSimulatorServiceUI = "OmsOutageSimulatorServiceUI";
