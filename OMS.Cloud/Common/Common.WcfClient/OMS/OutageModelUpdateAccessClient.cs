...
namespace OMS.Common.WcfClient.OMS
{
    public class OutageModelUpdateAccessClient : WcfSeviceFabricClientBase<IOutageModelUpdateAccessContract>, IOutageModelUpdateAccessContract
    {
        ...
        private static readonly string listenerName = EndpointNames.OmsOutageManagmenetServiceModelUpdateAccessEndpoint;
        ...
        public static OutageModelUpdateAccessClient CreateClient()
        {
            ClientFactory factory = new ClientFactory();
            return factory.CreateClient<OutageModelUpdateAccessClient, IOutageModelUpdateAccessContract>(microserviceName);
        }

        public static OutageModelUpdateAccessClient CreateClient(Uri serviceUri, ServicePartitionKey servicePartitionKey)
        {
            ClientFactory factory = new ClientFactory();
