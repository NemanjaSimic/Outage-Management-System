...
namespace SCADA.CommandingService
{
    ...
    {
        private const string serviceTypeName = "SCADA.CommandingServiceType";
        ...
        private static void Main()
        {
            ...
            try
            {
                ...
                ServiceRuntime.RegisterServiceAsync(serviceTypeName, context => new CommandingService(context)).GetAwaiter().GetResult();
