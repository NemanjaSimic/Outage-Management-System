...
namespace TestService
{
    ...
    {
        private const string serviceTypeName = "TestServiceType";
        ...
        private static void Main()
        {
            ...
            try
            {
                ...
                ServiceRuntime.RegisterServiceAsync(serviceTypeName, context => new TestService(context)).GetAwaiter().GetResult();
